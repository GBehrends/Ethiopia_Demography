...
proj_dir <- "<main project directory>"
setwd(<location of vcf files) # Setting wd to location of vcf files
sam_loc <- "<location of sample ID list>" # Location of Sample ID list 
out_dir <- "<location to place msmc files> # Location to put msmc files
...
x_files <- list.files(getwd(), pattern="*.vcf")
